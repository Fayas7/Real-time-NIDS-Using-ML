...
train_data = large_data.sample(frac=0.1, random_state=43)  # 10% of the data with a different random state
...
test_data = remaining_data.sample(frac=0.01, random_state=43)  # 10% of the remaining data
